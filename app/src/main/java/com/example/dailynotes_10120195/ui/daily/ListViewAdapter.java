package com.example.dailynotes_10120195.ui.daily;
...
import com.example.dailynotes_10120195.R;
import com.example.dailynotes_10120195.db.SQLite;
...
public class ListViewAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View view = LayoutInflater.from(context).inflate(layout.item_daily, null);


        judul = view.findViewById(id.title_daily);
        date = view.findViewById(id.cardDate);
        month = view.findViewById(id.cardMonth);
        year = view.findViewById(id.cardYear);
        isi = view.findViewById(id.desc_daily);
        opt = view.findViewById(id.options);
